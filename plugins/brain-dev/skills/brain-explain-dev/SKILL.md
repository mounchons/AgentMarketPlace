...
## Difference from `/brain-dev`
- `/brain-dev` = quick answer, concise
- `/brain-explain-dev` = deep analysis with diagrams, tables, code references, full context
...
3. **Check version history** (NEW)
   ...
   - If found, display brief version summary:
     ...
     📜 Version History:
       ...
       v2 — เพิ่ม OAuth2
       → /brain-history-dev {topic} เพื่อดูรายละเอียด
     ```
...
7. **Offer to save new findings**
   If codebase was read → offer `/brain-save-dev`
