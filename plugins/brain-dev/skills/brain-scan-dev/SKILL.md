...
When `/brain-scan-dev` is called without flags, it automatically decides what to do:
...
💡 ถัดไป:
   /brain-dev ทำไมเข้า JobList ไม่ได้    ← ถาม permission ได้เลย
   /brain-explain-dev billing             ← อธิบายแบบละเอียด
   /brain-search-dev JobAssignment        ← ค้นหา dependency map
```
