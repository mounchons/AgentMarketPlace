...
ต้องการบันทึกไหม? พิมพ์ /brain-save-dev เพื่อเก็บ
```
...
## Examples
```
/brain-dev checker ทำอะไรบ้าง
/brain-dev วิธีนำเข้าข้อมูลจาก Excel
/brain-dev workflow ตั้งแต่รับงานถึงส่งประกัน
/brain-dev database connection ใช้อะไรบ้าง
/brain-dev Lucky job ต่างจากงานปกติอย่างไร
```
